...
El parche 9.15.1 P14 ahora está disponible para Cloud Volumes ONTAP para todos los proveedores de nube. La NetApp Console le solicitará que actualice sus sistemas existentes a esta versión de parche.
...
El parche 9.15.1 P13 ahora está disponible para Cloud Volumes ONTAP para todos los proveedores de nube. La NetApp Console le solicitará que actualice sus sistemas existentes a esta versión de parche.
